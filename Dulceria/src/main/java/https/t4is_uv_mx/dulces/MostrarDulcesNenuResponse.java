...
// Generado el: 2022.05.17 a las 04:35:03 PM CDT 
//
...
@XmlRootElement(name = "MostrarDulcesNenuResponse")
public class MostrarDulcesNenuResponse {

    @XmlElement(required = true)
    protected List<MostrarDulcesNenuResponse.Dulces> dulces;
     ...
     * {@link MostrarDulcesNenuResponse.Dulces }
     * 
     * 
     */
    public List<MostrarDulcesNenuResponse.Dulces> getDulces() {
        if (dulces == null) {
            dulces = new ArrayList<MostrarDulcesNenuResponse.Dulces>();
        }
        return this.dulces;
    }
